  ...
  data(){
    return{
     ...
     swiperOptions: {
      ...
      carouseList:[//列表轮播 列表产品
        {img:'/images/carousel/1L-01.jpg'},
        {img:'/images/carousel/1L-02.jpg'},
        {img:'/images/carousel/1L-03.jpg'},
        {img:'/images/carousel/1L-04.jpg'},
      ]
    }
  },
  methods:{
